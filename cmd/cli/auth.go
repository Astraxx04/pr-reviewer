...
func webLogin(ctx context.Context) error {
	...
	srv := &http.Server{Handler: http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if tok == "" {
			...
			fmt.Fprint(w, loginResultHTML("Login failed", "No token was returned. You can close this tab and try again."))
			return
		}
		fmt.Fprint(w, loginResultHTML("You're signed in", "Authentication complete — return to your terminal. You can close this tab."))
		tokenCh <- tok
	})}
